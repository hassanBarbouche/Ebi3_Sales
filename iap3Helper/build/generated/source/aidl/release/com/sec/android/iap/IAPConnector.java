 ...
 * Original file: /Users/Hassan/Desktop/TLSAndroid/TLS/iap3Helper/src/main/aidl/com/sec/android/iap/IAPConnector.aidl
 */
...
case TRANSACTION_getItemsInbox2:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _arg1;
_arg1 = data.readString();
android.os.Bundle _result = this.getItemsInbox2(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public android.os.Bundle getItemsInbox2(java.lang.String packageName, java.lang.String itemIds) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
mRemote.transact(Stub.TRANSACTION_getItemsInbox2, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.os.Bundle.CREATOR.createFromParcel(_reply);
}
...
static final int TRANSACTION_getItemsInbox2 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
...
public android.os.Bundle getItemsInbox2(java.lang.String packageName, java.lang.String itemIds) throws android.os.RemoteException;
}
