...
import com.esprit.android.ebi3.adapters.SwipeCategorieVetementAdapter;
...
public class VetementListActivity extends BaseActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		nourlist.setBackgroundResource(R.drawable.vetementback);
		...
		final ProgressDialog loading = ProgressDialog.show(VetementListActivity.this,"Chargement...","Un petit moment svp...",false,false);
...
/*		if (SwipeCategorieAdapter.touched==true)
		...
		viewpager.setAdapter(new SwipeCategorieVetementAdapter(this));
		...
		nourlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(VetementListActivity.this, SingleProductActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.about:
			{
				Intent intent = new Intent(VetementListActivity.this, AboutActivity.class);
			...
			case R.id.HomeBtn:
			{Intent i = new Intent(VetementListActivity.this, Main.class);
				startActivity(i);
				finish();}
			break;
	...
	private class DrawerItemClickListener implements
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			if(position==1)
			{Intent intent = new Intent(VetementListActivity.this, NourritureListActivity.class);
				startActivity(intent);
				finish();}

			if(position==2)
			{Intent intent = new Intent(VetementListActivity.this, ArtisanatListActivity.class);
				startActivity(intent);
				finish();}

			if(position==3)
			{Intent intent = new Intent(VetementListActivity.this, ServiceListActivity.class);
				startActivity(intent);
				finish();}

			if(position==4)
			{Intent intent = new Intent(VetementListActivity.this, MultimediaListActivity.class);
				startActivity(intent);
				finish();}
			...
			if(position==5)
			{Intent intent = new Intent(VetementListActivity.this, ImmobilierListActivity.class);
				startActivity(intent);
				finish();}

			if(position==6)
			{Intent intent = new Intent(VetementListActivity.this, VetementListActivity.class);
				startActivity(intent);
				finish();}

			if(position==7)
			{Intent intent = new Intent(VetementListActivity.this, RechercheActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==8)
			{Intent intent = new Intent(VetementListActivity.this, ProfileActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==9)
			{Intent intent = new Intent(VetementListActivity.this, Welcome.class);
				startActivity(intent);
				finish();
			}
		}
	...
	public void onMenuItemClick(View clickedView, int position) {
		...
		{   AddProductActivity.categorie="Nourriture";
			...
			Intent intent = new Intent(VetementListActivity.this, AddProductActivity.class);
			startActivity(intent);
			finish();
		}
		if(position==2)
