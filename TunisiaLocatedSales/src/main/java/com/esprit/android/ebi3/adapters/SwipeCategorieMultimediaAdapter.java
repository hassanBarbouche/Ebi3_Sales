...
import com.esprit.android.ebi3.MultimediaListActivity;
...
public class SwipeCategorieMultimediaAdapter extends PagerAdapter {
    ...
    public SwipeCategorieMultimediaAdapter(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      final  Button third = (Button) item_view.findViewById(R.id.thirdicone);
        ...
        if(position==0)
        {
            ...
            first.setBackgroundResource(R.drawable.multimediablanc);
            second.setBackgroundResource(R.drawable.smartphone);
            third.setBackgroundResource(R.drawable.tv);
            forth.setBackgroundResource(R.drawable.son);
            ftext.setText("Ordinateur");
            stext.setText("Smartphone");
            ttext.setText("TV");
            fotext.setText("Son");
            ...
            first.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                  ...
                  // Save new user data into Parse.com Data Storage
                    touched = true;
                    first.setBackgroundResource(R.drawable.multimediacouleur);
                    second.setBackgroundResource(R.drawable.smartphone);
                    third.setBackgroundResource(R.drawable.tv);
                    forth.setBackgroundResource(R.drawable.son);
                    ...
                    CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, showUrl, params, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                MultimediaListActivity.nourlist.setAdapter(new ProduitCustomAdapter(ctx, R.layout.one_article_main, imgList2));
                                loading.dismiss();
            ...
            second.setOnTouchListener(new View.OnTouchListener() {
                ...
                // Save new user data into Parse.com Data Storage
                    touched = true;
                    first.setBackgroundResource(R.drawable.multimediablanc);
                    second.setBackgroundResource(R.drawable.smartphonecouleur);
                    third.setBackgroundResource(R.drawable.tv);
                    forth.setBackgroundResource(R.drawable.son);
                    Map<String, String> params = new HashMap<String, String>();
                    params.put("category", "Multimedia");
                    params.put("SubCategory", "Smartphone");
            ...
            third.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                 ...
                 // Save new user data into Parse.com Data Storage
                    ...
                    first.setBackgroundResource(R.drawable.multimediablanc);
                    second.setBackgroundResource(R.drawable.smartphone);
                    third.setBackgroundResource(R.drawable.tvcouleur);
                    forth.setBackgroundResource(R.drawable.son);
            ...
            forth.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                  ...
                  // Save new user data into Parse.com Data Storage
                    ...
                    second.setBackgroundResource(R.drawable.smartphone);
                    third.setBackgroundResource(R.drawable.tv);
                    forth.setBackgroundResource(R.drawable.soncouleur);
        ...
        if(position==1)
        {
            first.setBackgroundResource(R.drawable.apphoto);
            second.setBackgroundResource(R.drawable.cd);
            ...
            ftext.setText("Photographie");
            stext.setText("Film et Musique");
            ttext.setText("");
            fotext.setText("");
            ...
            first.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                  ...
                  // Save new user data into Parse.com Data Storage
                    touched = true;
                    first.setBackgroundResource(R.drawable.apphotocouleur);
                    second.setBackgroundResource(R.drawable.cd);
                    third.setBackgroundResource(R.drawable.mmaison);
                    forth.setBackgroundResource(R.drawable.epice);
            ...
            second.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                 ...
                 // Save new user data into Parse.com Data Storage
                    touched = true;
                    first.setBackgroundResource(R.drawable.apphoto);
                    second.setBackgroundResource(R.drawable.cdcouleur);
                    third.setBackgroundResource(R.drawable.mmaison);
                    forth.setBackgroundResource(R.drawable.epice);
