...
import com.esprit.android.ebi3.adapters.SwipeCategorieMultimediaAdapter;
...
public class MultimediaListActivity extends BaseActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		nourlist.setBackgroundResource(R.drawable.multimediaback2);
		...
		if(extras!=null){
			...
			{
				if(extras.getString("From").equals("Ordinateur"))
				{


					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "Ordinateur");

				}
				if(extras.getString("From").equals("Telephone"))
				{
					...
					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "Telephone");
					//WelcomeListNourriture.From=null;

				}

				if(extras.getString("From").equals("TV"))
				{


					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "TV");

				}

				if(extras.getString("From").equals("Son"))
				{


					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "Son");

				}

				if(extras.getString("From").equals("Photographie"))
				{
					...
					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "Photographie");

				}

				if(extras.getString("From").equals("Film et Musique"))
				{


					params = new HashMap<String, String>();
					params.put("category", "Multimedia");
					params.put("SubCategory", "Film et Musique");
		...
		final ProgressDialog loading = ProgressDialog.show(MultimediaListActivity.this,"Chargement...","Un petit moment svp...",false,false);
...
/*		if (SwipeCategorieAdapter.touched==true)
		...
		viewpager.setAdapter(new SwipeCategorieMultimediaAdapter(this));
		...
		nourlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(MultimediaListActivity.this, SingleProductActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.HomeBtn:
			{Intent i = new Intent(MultimediaListActivity.this, Main.class);
				startActivity(i);
				finish();}
			break;
			case R.id.about:
			{
				Intent intent = new Intent(MultimediaListActivity.this, AboutActivity.class);
	...
	private class DrawerItemClickListener implements
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			if(position==1)
			{Intent intent = new Intent(MultimediaListActivity.this, NourritureListActivity.class);
				startActivity(intent);
				finish();}

			if(position==2)
			{Intent intent = new Intent(MultimediaListActivity.this, ArtisanatListActivity.class);
				startActivity(intent);
				finish();}

			if(position==3)
			{Intent intent = new Intent(MultimediaListActivity.this, ServiceListActivity.class);
				startActivity(intent);
				finish();}

			if(position==4)
			{Intent intent = new Intent(MultimediaListActivity.this, MultimediaListActivity.class);
				startActivity(intent);
				finish();}
			...
			if(position==5)
			{Intent intent = new Intent(MultimediaListActivity.this, ImmobilierListActivity.class);
				startActivity(intent);
				finish();}

			if(position==6)
			{Intent intent = new Intent(MultimediaListActivity.this, VetementListActivity.class);
				startActivity(intent);
				finish();}

			if(position==7)
			{Intent intent = new Intent(MultimediaListActivity.this, RechercheActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==8)
			{Intent intent = new Intent(MultimediaListActivity.this, ProfileActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==9)
			{Intent intent = new Intent(MultimediaListActivity.this, Welcome.class);
				startActivity(intent);
				finish();
			}
		}
	...
	public void onMenuItemClick(View clickedView, int position) {
		...
		{   AddProductActivity.categorie="Nourriture";
			...
			Intent intent = new Intent(MultimediaListActivity.this, AddProductActivity.class);
			startActivity(intent);
			finish();
		}
		if(position==2)
