...
public class SwipeCategorieArtisanatAdapter extends PagerAdapter {
    ...
    public SwipeCategorieArtisanatAdapter(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      final  Button third = (Button) item_view.findViewById(R.id.thirdicone);
        ...
        if(position==0)
        {
            first.setBackgroundResource(R.drawable.bbroderie);
            second.setBackgroundResource(R.drawable.ttapis);
            third.setBackgroundResource(R.drawable.ppoterie);
            forth.setBackgroundResource(R.drawable.ppainting);
            ftext.setText("Broderie");
            stext.setText("Tappiserie");
            ttext.setText("Potterie");
            fotext.setText("Peinture");
            ...
            first.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    touched = true;
                    first.setBackgroundResource(R.drawable.bbroderiecouleur);
                    second.setBackgroundResource(R.drawable.ttapis);
                    third.setBackgroundResource(R.drawable.ppoterie);
                    forth.setBackgroundResource(R.drawable.ppainting);
            ...
            second.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    touched = true;
                    first.setBackgroundResource(R.drawable.bbroderie);
                    second.setBackgroundResource(R.drawable.ttapiscouleur);
                    third.setBackgroundResource(R.drawable.ppoterie);
                    forth.setBackgroundResource(R.drawable.ppainting);
                    Map<String, String> params = new HashMap<String, String>();
                    params.put("category", "Artisanat");
            ...
            third.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    first.setBackgroundResource(R.drawable.bbroderie);
                    second.setBackgroundResource(R.drawable.ttapis);
                    third.setBackgroundResource(R.drawable.ppoteriecouleur);
                    forth.setBackgroundResource(R.drawable.ppainting);
            ...
            forth.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    second.setBackgroundResource(R.drawable.ttapis);
                    third.setBackgroundResource(R.drawable.ppoterie);
                    forth.setBackgroundResource(R.drawable.ppaintingcouleur);
        ...
        if(position==1)
        {
            ...
            ftext.setText("Bois");
            stext.setText("Instruments");
            ttext.setText("Maison");
            fotext.setText("");
            ...
            first.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    // Save new user data into Parse.com Data Storage
                    touched = true;
                    first.setBackgroundResource(R.drawable.bboiscouleur);
                    second.setBackgroundResource(R.drawable.gguitar);
                    third.setBackgroundResource(R.drawable.mmaison);
                    forth.setBackgroundResource(R.drawable.epice);
            ...
            second.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    touched = true;
                    first.setBackgroundResource(R.drawable.bbois);
                    second.setBackgroundResource(R.drawable.gguitarcouleur);
                    third.setBackgroundResource(R.drawable.mmaison);
                    forth.setBackgroundResource(R.drawable.epice);
