...
import com.esprit.android.ebi3.models.DummyModel;
import com.esprit.android.ebi3.R;
import com.esprit.android.ebi3.models.ImageGalleryCategoryModel;
import com.esprit.android.ebi3.models.ImageGallerySubcategoryModel;
...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getSocialDummyListImage() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, R.drawable.nourriturescouleur,"Nourriture","Légumes,Fruits,Viandes,A Manger,Oeufs,Miel,Céréales,Poissons,Huiles...",1));
		list.add(new DummyModel(1, R.drawable.artisanatcouleur,"Artisanat","Tapisserie,Broderie,Poterie,Peinture,Couture,Menuiserie,Céramique...",1));
		list.add(new DummyModel(2, R.drawable.servicecouleur,"Services","Ménage,plomberie,Eduquation,Babysitting,Cuisine...",1));
		list.add(new DummyModel(3, R.drawable.icn_multimedia,"Multimedia","Ordinateur,Téléphones,TV,Son...",1));
		list.add(new DummyModel(4, R.drawable.immobiliercouleur,"Immobilier","Appartement,Maison,Garage,Locale,A louer,A vendre...",1));
		list.add(new DummyModel(5, R.drawable.vetementcouleur,"Vetements","Pulls,Chemise,Pantalons,Chaussure,Bijoux...",1));
		list.add(new DummyModel(6, R.drawable.looop,"Recherche","Rechercher votre produit ou service par ville , par catégorie ou par prix",1));
		list.add(new DummyModel(7, R.drawable.settingss,"Votre Compte","Mettre a jour votre compte , vos produits et vos services",1));
		list.add(new DummyModel(8, R.drawable.logout,"Déconnexion","Au revoir et a la prochaine connexion...",1));
		return list;
	}
