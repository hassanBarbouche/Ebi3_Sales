...
import com.esprit.android.ebi3.adapters.SwipeCategorieAdapter;
...
public class NourritureListActivity extends BaseActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
	...
	/*	if (SwipeCategorieAdapter.touched==true)
		...
		{
		if(extras.getString("From").equals("Legumes"))
		{
			...
			if(extras.getString("From").equals("Cereales"))
			{
			...
			if(extras.getString("From").equals("Oeufs"))
			{
			...
			if(extras.getString("From").equals("Fruits"))
			{
			...
			if(extras.getString("From").equals("A manger"))
			{
			...
			if(extras.getString("From").equals("Miel"))
			{
			...
			if(extras.getString("From").equals("Poisson"))
			{
			...
			if(extras.getString("From").equals("Epices"))
			{
		...
		final ProgressDialog loading = ProgressDialog.show(NourritureListActivity.this,"Chargement...","Un petit moment svp...",false,false);
	...
	//	else nourlist.setAdapter(new ProduitCustomAdapter(getBaseContext(), R.layout.one_article_main, imgList1));
	 ...
	 viewpager=(ViewPager)findViewById(R.id.categorieViewPager);
		viewpager.setAdapter(new SwipeCategorieAdapter(this));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.HomeBtn:
			{Intent i = new Intent(NourritureListActivity.this, Main.class);
				startActivity(i);
				finish();}
				break;
			case R.id.about:
			{
				Intent intent = new Intent(NourritureListActivity.this, AboutActivity.class);
	...
	private class DrawerItemClickListener implements
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			if(position==1)
			{Intent intent = new Intent(NourritureListActivity.this, NourritureListActivity.class);
				startActivity(intent);
				finish();}

			if(position==2)
			{Intent intent = new Intent(NourritureListActivity.this, ArtisanatListActivity.class);
				startActivity(intent);
				finish();}

			if(position==3)
			{Intent intent = new Intent(NourritureListActivity.this, ServiceListActivity.class);
				startActivity(intent);
				finish();}

			if(position==4)
			{Intent intent = new Intent(NourritureListActivity.this, MultimediaListActivity.class);
				startActivity(intent);
				finish();}
			...
			if(position==5)
			{Intent intent = new Intent(NourritureListActivity.this, ImmobilierListActivity.class);
				startActivity(intent);
				finish();}

			if(position==6)
			{Intent intent = new Intent(NourritureListActivity.this, VetementListActivity.class);
				startActivity(intent);
				finish();}

			if(position==7)
			{Intent intent = new Intent(NourritureListActivity.this, RechercheActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==8)
			{Intent intent = new Intent(NourritureListActivity.this, ProfileActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==10)
			{Intent intent = new Intent(NourritureListActivity.this, Welcome.class);
				startActivity(intent);
				finish();
			}
		}
	...
	public void onMenuItemClick(View clickedView, int position) {
		...
		{   AddProductActivity.categorie="Nourriture";
			...
			Intent intent = new Intent(NourritureListActivity.this, AddProductActivity.class);
			startActivity(intent);
			finish();
		}
		if(position==2)
	...
	class BackGround extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String s) {
			...
			} catch (JSONException e)
			{
				...
				if(e!=null){ Toast.makeText(NourritureListActivity.this, "User not found", Toast.LENGTH_LONG).show();}
			}
