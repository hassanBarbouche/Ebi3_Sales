...
import com.esprit.android.ebi3.adapters.ProduitProfileCustomAdapter;
...
public class ProfileActivity extends BaseActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {

	RequestQueue requestQueue1;
	String showUrl = "http://www.e-bi3.com/server/getProfileElements.php";
	...
	/*	BackGround b = new BackGround();
		...
		final ProgressDialog loading = ProgressDialog.show(ProfileActivity.this,"Chargement...","Un petit moment svp...",false,false);
		CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, showUrl, params, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				try {
					...
					nourlist.setAdapter(new ProduitProfileCustomAdapter(getBaseContext(), R.layout.one_article_profile, ListNourriture));
					loading.dismiss();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.HomeBtn:
			{Intent i = new Intent(ProfileActivity.this, Main.class);
				startActivity(i);
				finish();}
				break;
	...
	private class DrawerItemClickListener implements
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			if(position==1)
			{Intent intent = new Intent(ProfileActivity.this, NourritureListActivity.class);
				startActivity(intent);
				finish();}

			if(position==2)
			{Intent intent = new Intent(ProfileActivity.this, ArtisanatListActivity.class);
				startActivity(intent);
				finish();}

			if(position==3)
			{Intent intent = new Intent(ProfileActivity.this, ServiceListActivity.class);
				startActivity(intent);
				finish();}

			if(position==4)
			{Intent intent = new Intent(ProfileActivity.this, MultimediaListActivity.class);
				startActivity(intent);
				finish();}
			...
			if(position==5)
			{Intent intent = new Intent(ProfileActivity.this, ImmobilierListActivity.class);
				startActivity(intent);
				finish();}

			if(position==6)
			{Intent intent = new Intent(ProfileActivity.this, VetementListActivity.class);
				startActivity(intent);
				finish();}

			if(position==7)
			{Intent intent = new Intent(ProfileActivity.this, RechercheActivity.class);
				startActivity(intent);
				finish();
			}
			if(position==8)
	...
	class BackGround extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String s) {
			...
			} catch (JSONException e)
			{
				...
				if(e!=null){ Toast.makeText(ProfileActivity.this, "User not found", Toast.LENGTH_LONG).show();}
			}
